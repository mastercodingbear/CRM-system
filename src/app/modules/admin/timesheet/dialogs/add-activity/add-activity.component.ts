...
import { ACTIVITY_OPTIONS } from 'app/core/config/timesheet.config';

@Component({
  selector: 'timesheet-add-activity',
...
export class AddActivityComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activityField = { Type: 'ddl', Label: 'Activity', Options: ACTIVITY_OPTIONS };
  }
  /**
  ...
  submitActivity(): void {
    ...
    const activity: string = this.timesheetForm.controls['activity'].value;
    // Close the dialog
