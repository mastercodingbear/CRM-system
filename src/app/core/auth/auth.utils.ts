...
import { KoneQTDate } from './auth.type';
...
export class AuthUtils {
   ...
   * @param expiresIn
   */
  static isTokenExpired(token: string, expiresIn: KoneQTDate): boolean {
    ...
    return !(new Date(expiresIn.date).valueOf() > new Date().valueOf());
  }
